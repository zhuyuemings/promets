...
import ltd.jezhu.promets.system.exception.DaoException;
...
//    }
    ...
    @Override
    public Connection getNewConnection() throws SystemException {
        DataSource ds;
        try {
    ...
    @Override
    public int insert(final String statementName) throws SystemException {
        return this.insert(statementName, null);
    }

    @Override
    public int insert(final String statementName, final Object parameterObject) throws SystemException {
        try {
    ...
    @Override
    public int update(String statementName) throws SystemException {
        return this.update(statementName, null);
    }

    @Override
    public int update(final String statementName, final Object parameterObject) throws SystemException {
        try {
            if (log.isDebugEnabled() && parameterObject != null) {
                log.debug(parameterObject.toString());
            }
    ...
    @Override
    public int delete(String statementName) throws SystemException {
        return this.delete(statementName, null);
    }

    @Override
    public int delete(final String statementName, final Object parameterObject) throws SystemException {
        try {
            if (log.isDebugEnabled() && parameterObject != null) {
                log.debug(parameterObject.toString());
            }
    ...
    @Override
    public <T> T queryForObject(String statementName) throws SystemException {
        try {
    ...
    @Override
    public <T> T queryForObject(final String statementName, final Object parameterObject) throws SystemException {
        try {
            if (log.isDebugEnabled() && parameterObject != null) {
                log.debug(parameterObject.toString());
            }
    ...
    @Override
    public <E> List<E> queryForList(String statementName) throws SystemException {
        return this.queryForList(statementName, null);
    }

    @Override
    public <E> List<E> queryForList(final String statementName, final Object parameterObject) throws SystemException {
        try {
            if (log.isDebugEnabled() && parameterObject != null) {
                log.debug(parameterObject.toString());
            }
    ...
    @Override
    public int batchUpdate(final String statementName, final List list) throws SystemException {
    ...
    @Override
    public int batchInsert(final String statementName, final List list) throws SystemException {
        SqlSession session = null;
        int count;
        try {
            Integer updateCounts = 0;
    ...
    @Override
    public int batchDelete(final String statementName, final List list) throws SystemException {
        SqlSession session = null;
        int count;
        try {
            Integer updateCounts = 0;
    ...
    @Override
    public List queryForListBeginEnd(final String statementName, final int begin, final int end) throws SystemException {
        return this.queryForListBeginEnd(statementName, null, begin, end);
    }

    @Override
    public List queryForListBeginEnd(final String statementName, final Object parameterObject, final int begin, final int end) throws SystemException {
        if (begin < 0) {
    ...
    @Override
    public PageInfo queryForPagingList(String statementName, int offsize, int limit) throws SystemException {
        return this.queryForPagingList(statementName, null, offsize, limit);
    }

    @Override
    public PageInfo queryForPagingList(final String statementName, final Object parameterObject, final int offsize, final int limit) throws SystemException {
        PageInfo pageInfo;
        try {
