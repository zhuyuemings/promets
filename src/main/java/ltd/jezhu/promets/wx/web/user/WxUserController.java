package ltd.jezhu.promets.wx.web.user;

import ltd.jezhu.promets.base.exception.SystemException;
...
import ltd.jezhu.promets.wx.dao.user.WxUserInfoDao;
...
public class WxUserController {
    ...
    @Autowired
    public WxUserController(WxUserInfoDao wxUserInfoDao) {
